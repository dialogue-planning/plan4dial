...
def update_config_clarification(loaded_yaml: Dict, original_act_name: str, entities: List[str], clarify: Dict, additional_updates: Dict=None):
    new_actions, new_ctx_vars = create_clarifications_single_slots(original_act_name, loaded_yaml["actions"][original_act_name], entities, clarify, additional_updates)
